...
public class SecurityHelper {
    ...
    public static boolean isWeakPassword(String password) {
        ...
        return StringHelper.isEmpty(password) || password.length() < 8 || !lowerCasePattern.matcher(password)
    ...
    public static String baseStringFixed(Object num, int base, int minLength, char padChar) {
        return StringHelper.leftPad(baseStringFixed(num, base), minLength, padChar);
    }
