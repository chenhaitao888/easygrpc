 ...
 * @date : 11:45 上午 2020/10/9
 */
public class EasyRpcParseHelper {
    ...
    public static String genArgJsons(Object[] args) {
        ...
        try {
            ...
            throw new EasyGrpcException("Fail to Serialize Args!", e);
        }
    }

    /**
     * 将服务端接收到的json格式的请求参数，解析成参数名->对象，存储在map对象中返回
     */
    public static Map<String, Object> parseArgs(String argsJson, MethodInfo methodInfo) {
        try {
            ...
            throw new IllegalArgumentException("Fail to Parse Args!", e);
        }
    }
